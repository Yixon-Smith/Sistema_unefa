...
INNER JOIN area ON documento.area_cod = area.area_cod order by documento_cod";
	...
	$pdf->AliasNbPages();
	$pdf->AddPage();
	$pdf->Image('../../LogoUnefaPDF.png', 15, 5, 20 );
	$pdf->SetFont('Courier','B',15);
	$pdf->Cell(70);
	$pdf->Cell(120,10, 'Expediente Unefa',0,0,'C');
	$pdf->Ln(30);
	$pdf->SetFont('Courier','B',12);
	$pdf->SetFillColor(232,232,232);
	$pdf->SetFont('Courier','B',10);
	$pdf->Cell(25,6,utf8_decode('CÓDIGO'),1,0,'C',1);
	$pdf->Cell(80,6,utf8_decode('Estudiante'),1,0,'C',1);
	$pdf->Cell(101,6,'Descripcion',1,0,'C',1);
	$pdf->Cell(35,6,utf8_decode('FECHA RECEPCIÓN'),1,0,'C',1);
	$pdf->Cell(35,6,'departamento',1,1,'C',1);
